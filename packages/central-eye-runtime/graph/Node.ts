...
export type NodeType = 'collector' | 'switch' | 'router' | 'server' | 'database' | 'firewall' | 'application' | 'network';
export type NodeStatus = 'healthy' | 'degraded' | 'offline' | 'unknown' | 'unreachable';
...
export class GraphNode {
  ...
  public isRootCause: boolean = false;
